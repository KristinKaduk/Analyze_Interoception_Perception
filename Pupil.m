...
if preprocessing.CreateMatFiles
    ...
    for fileIndx = 1:numel(files)
        ...
        mkdir(['C:\Users\kkaduk\Desktop\Kristin\Projects\Metacognition_Interoception_Human\Perceptual_Certainty\Analyze\Pupil\matfiles\',files(fileIndx).name(1:6)] )
        ...
        for TrialIndex = 1: length(succesfull_Trials) ; %TrialIndex = 65
           ...
           % t_ms(find(Difference > 60000))'
            ...
            zeroTime_ms = t_ms(1);
            %t_ms        = (t_ms - (Data.trial(TrialIndx).Trial_start_time_run*1000)); %Data.trial(TrialIndx).Trial_start_time_run
            ...
            if preprocessing.GraphsPreprocessing ;
                ...
                onset_Ind_TrialStart = Data.trial(TrialIndx).Trial_start_time_run*1000 ; %- Data.trial(DaTab(NrTrial).Ind_CompletedTrials).Trial_start_time_run;
                onset_IndSample         = Data.trial(TrialIndx).Time_sample_appeared_run*1000 ;  %-Data.trial(DaTab(NrTrial).Ind_CompletedTrials).Trial_start_time_run;
                onset_Ind_M2S           = Data.trial(TrialIndx).Time_matchtosample_appeared_run*1000 ;  %-Data.trial(DaTab(NrTrial).Ind_CompletedTrials).Trial_start_time_run;
                onset_Ind_M2S_selected  = Data.trial(TrialIndx).Time_match_to_sample_selected_run*1000 ;  %-Data.trial(DaTab(NrTrial).Ind_CompletedTrials).Trial_start_time_run;
                onset_Ind_PostCertainty = Data.trial(TrialIndx).Wager_start_time_wagering_post_run*1000 ;  %-Data.trial(DaTab(NrTrial).Ind_CompletedTrials).Trial_start_time_run;
                onset_Ind_PreCertainty  = Data.trial(TrialIndx).Wager_start_time_wagering_pre_run*1000 ; % -Data.trial(DaTab(NrTrial).Ind_CompletedTrials).Trial_start_time_run;
                yPosition = -2.5;
                ...
                %
                print(p0,['C:\Users\kkaduk\Desktop\Kristin\Projects\Metacognition_Interoception_Human\Perceptual_Certainty\Analyze\Pupil\Graph_rawData\',...
                ...
                print(p1,['C:\Users\kkaduk\Desktop\Kristin\Projects\Metacognition_Interoception_Human\Perceptual_Certainty\Analyze\Pupil\Graph_SamplingRate\',...
            ...
            cd(['C:\Users\kkaduk\Desktop\Kristin\Projects\Metacognition_Interoception_Human\Perceptual_Certainty\Analyze\Pupil\matfiles\',files(fileIndx).name(1:6)])
...
path       = 'C:\Users\kkaduk\Desktop\Kristin\Projects\Metacognition_Interoception_Human\Perceptual_Certainty\Analyze\Pupil\matfiles\';
Folder     = dir(path );
Folder(1:2)=[]; 
...
%for fileIndx = 1:length(rawFiles)
    ...
    if preprocessing.GraphsPreprocessing
        ...
        onset_Ind_TrialStart = Data.trial(succesfull_Trials(NrTrial)).Trial_start_time_run; %- Data.trial(DaTab(NrTrial).Ind_CompletedTrials).Trial_start_time_run;
        onset_IndSample         = Data.trial(succesfull_Trials(NrTrial)).Time_sample_appeared_run ;  %-Data.trial(DaTab(NrTrial).Ind_CompletedTrials).Trial_start_time_run;
            yPosition = -2.5;
            line([onset_IndSample onset_IndSample], get(gca,'YLim'),'Color','black','LineStyle','--');
        ...
        print(p1,['C:\Users\kkaduk\Desktop\Kristin\Projects\Metacognition_Interoception_Human\Perceptual_Certainty\Analyze\Pupil\Graph_Filtered\',...
    ...
    if preprocessing.GraphsPreprocessing
        ...
        for NrTrial =  1: length(hPupilData)
           ...
           print(p2,['C:\Users\kkaduk\Desktop\Kristin\Projects\Metacognition_Interoception_Human\Perceptual_Certainty\Analyze\Pupil\Graph_SmoothedInterpolated_WithGaps\',...
    ...
    for NrTrial =   1: length(DaTab);
        ...
        DaTab(NrTrial).Trial_start_time_run             = Data.trial(DaTab(NrTrial).Ind_CompletedTrials).Trial_start_time_run;
        DaTab(NrTrial).Trial_finish_time_run            = Data.trial(DaTab(NrTrial).Ind_CompletedTrials).Trial_finish_time_run ;  %-Data.trial(DaTab(NrTrial).Ind_CompletedTrials).Trial_start_time_run;
        ...
        DaTab(NrTrial).Time_sample_appeared_run_trial   = Data.trial(DaTab(NrTrial).Ind_CompletedTrials).Time_sample_appeared_run ; %-Data.trial(DaTab(NrTrial).Ind_CompletedTrials).Trial_start_time_run;
        ...
        [c ,DaTab(NrTrial).index_TrialStart]          = min(abs(hPupilData(NrTrial).leftPupil_ValidSamples.signal.t - (Data.trial(DaTab(NrTrial).Ind_CompletedTrials).Trial_start_time_run )));
        [c ,DaTab(NrTrial).index_SampleAppears]       = min(abs(hPupilData(NrTrial).leftPupil_ValidSamples.signal.t - (Data.trial(DaTab(NrTrial).Ind_CompletedTrials).Time_sample_appeared_run )));
        [c ,DaTab(NrTrial).index_SampleDisappears]    = min(abs(hPupilData(NrTrial).leftPupil_ValidSamples.signal.t - (Data.trial(DaTab(NrTrial).Ind_CompletedTrials).Time_sample_disappeared_run )));
        [c ,DaTab(NrTrial).index_PercChoiceAppears]   = min(abs(hPupilData(NrTrial).leftPupil_ValidSamples.signal.t - (Data.trial(DaTab(NrTrial).Ind_CompletedTrials).Time_matchtosample_appeared_run )));
        [c ,DaTab(NrTrial).index_PercChoice_Selected] = min(abs(hPupilData(NrTrial).leftPupil_ValidSamples.signal.t - (Data.trial(DaTab(NrTrial).Ind_CompletedTrials).Time_match_to_sample_selected_run )));
        [c ,DaTab(NrTrial).index_PercChoice_Selected_TimeLater] = min(abs(hPupilData(NrTrial).leftPupil_ValidSamples.signal.t - ((Data.trial(DaTab(NrTrial).Ind_CompletedTrials).Time_match_to_sample_selected_run ) +4)));
        [c ,DaTab(NrTrial).index_TrialEnd]            = min(abs(hPupilData(NrTrial).leftPupil_ValidSamples.signal.t - (Data.trial(DaTab(NrTrial).Ind_CompletedTrials).Trial_finish_time_run - Data.trial(DaTab(NrTrial).Ind_CompletedTrials).Trial_start_time_run)));
    ...
    if preprocessing.GraphsPreprocessing
        ...
        for NrTrial =  1: length(hPupilData) %Nr. of completed trials
            ...
            onset_Ind_Time_Fix1Base = Data.trial(DaTab(NrTrial).Ind_CompletedTrials).Time_pressed_rest_Fix1Base_run ;%- Data.trial(DaTab(NrTrial).Ind_CompletedTrials).Trial_start_time_run;
            onset_IndSample         = Data.trial(DaTab(NrTrial).Ind_CompletedTrials).Time_sample_appeared_run ;%-Data.trial(DaTab(NrTrial).Ind_CompletedTrials).Trial_start_time_run;
            onset_Ind_M2S           = Data.trial(DaTab(NrTrial).Ind_CompletedTrials).Time_matchtosample_appeared_run; %-Data.trial(DaTab(NrTrial).Ind_CompletedTrials).Trial_start_time_run;
            onset_Ind_M2S_selected  = Data.trial(DaTab(NrTrial).Ind_CompletedTrials).Time_match_to_sample_selected_run; %-Data.trial(DaTab(NrTrial).Ind_CompletedTrials).Trial_start_time_run;
            onset_Ind_PostCertainty = Data.trial(DaTab(NrTrial).Ind_CompletedTrials).Wager_start_time_wagering_post_run ;%-Data.trial(DaTab(NrTrial).Ind_CompletedTrials).Trial_start_time_run;
            onset_Ind_PreCertainty  = Data.trial(DaTab(NrTrial).Ind_CompletedTrials).Wager_start_time_wagering_pre_run; % -Data.trial(DaTab(NrTrial).Ind_CompletedTrials).Trial_start_time_run;
            yPosition = -2.5;
            line([onset_IndSample onset_IndSample], get(gca,'YLim'),'Color','black','LineStyle','--');
            ...
            print(p4,['C:\Users\kkaduk\Desktop\Kristin\Projects\Metacognition_Interoception_Human\Perceptual_Certainty\Analyze\Pupil\Graph_SmoothedInterpolated_MarkedEvents\',...
                rawFiles(fileIndx).name(1:end-6),'_', num2str(NrTrial), '_smoothed_Interpolated'],'-dpng','-r0') %dpng
            close all;
        end
    end
    %% BaselineCorrection
     for NrTrial = 1:length(hPupilData)
    hPupilData(NrTrial).leftPupil_ValidSamples.signal.t_Baselinecorected                            = hPupilData(NrTrial).leftPupil_ValidSamples.signal.t                            - hPupilData(NrTrial).leftPupil_ValidSamples.signal.t(DaTab(NrTrial).index_SampleAppears);
    ...
    for i = 1:length(difficultyLevels)
        counter = 0;
        for i_Sample = 1: 6000 %min([DaTab.SamplesBetweenSample_PercChoice_Selected_TimeLater])
    ...
    for i_diff = 1:length(difficultyLevels)
     ...
     print(p5,['C:\Users\kkaduk\Desktop\Kristin\Projects\Metacognition_Interoception_Human\Perceptual_Certainty\Analyze\Pupil\Graph_DifficultyLevels\',...
     ...
     print(p6,['C:\Users\kkaduk\Desktop\Kristin\Projects\Metacognition_Interoception_Human\Perceptual_Certainty\Analyze\Pupil\Graph_DifficultyLevels\',...
     files(i_Folder).name(1:end-4), 'DifficultyLevels_Average'],'-dpng','-r0') %dpng
 close all; 
